...
function Footer() {
  return (
    <div className='flex flex-row justify-between mt-40 w-full px-5 py-5 bg-blue-400' id='contact'>
      ...
      <div className="flex flex-col mr-10 lg:mr-20 mb-2 h-20 bg-red-500">
