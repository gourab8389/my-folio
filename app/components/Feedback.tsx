...
export function Feedback() {
  return (
    <div id="feedback" className="lg:w-[32rem] w-[25rem]  mx-10 sm:mx-4 rounded-xl md:rounded-2xl p-3 sm:p-8 shadow-input bg-gray-50 dark:bg-gray-950 mt-10 border border-gray-200 dark:border-gray-600">
