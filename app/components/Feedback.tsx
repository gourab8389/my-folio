...
export function Feedback() {
  return (
    <div id="feedback" className="lg:w-[32rem] w-80  mx-10 sm:mx-4 rounded-xl md:rounded-2xl p-4 sm:p-8 shadow-input bg-gray-100 dark:bg-gray-950 mt-10 border border-gray-800">
